 ...
 * <ul>
 *   <li>{@link RefUML.impl.CommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link RefUML.impl.CommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentImpl extends ElementImpl implements Comment {
	...
	protected EClass eStaticClass() {
		return RefUMLPackage.Literals.COMMENT;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefUMLPackage.COMMENT__BODY, oldBody, body, !oldBodyESet));
	}
	...
	public void unsetBody() {
		...
		bodyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RefUMLPackage.COMMENT__BODY, oldBody, BODY_EDEFAULT, oldBodyESet));
	}
	...
	public EList<Element> getAnnotatedElement() {
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList<Element>(Element.class, this, RefUMLPackage.COMMENT__ANNOTATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefUMLPackage.COMMENT__BODY:
				return getBody();
			case RefUMLPackage.COMMENT__ANNOTATED_ELEMENT:

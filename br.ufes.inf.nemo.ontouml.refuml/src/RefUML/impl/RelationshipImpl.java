 ...
 * <ul>
 *   <li>{@link RefUML.impl.RelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationshipImpl extends ElementImpl implements Relationship {
	...
	protected EClass eStaticClass() {
		return RefUMLPackage.Literals.RELATIONSHIP;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefUMLPackage.RELATIONSHIP__RELATED_ELEMENT:

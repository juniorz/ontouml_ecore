 ...
 * <ul>
 *   <li>{@link RefUML.impl.LiteralUnlimitedNaturalImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralUnlimitedNaturalImpl extends LiteralSpecificationImpl implements LiteralUnlimitedNatural {
	...
	protected EClass eStaticClass() {
		return RefUMLPackage.Literals.LITERAL_UNLIMITED_NATURAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefUMLPackage.LITERAL_UNLIMITED_NATURAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefUMLPackage.LITERAL_UNLIMITED_NATURAL__VALUE:
				return getValue();
		}

 ...
 * <ul>
 *   <li>{@link RefUML.impl.SlotImpl#getDefiningFeature <em>Defining Feature</em>}</li>
 *   <li>{@link RefUML.impl.SlotImpl#getValue <em>Value</em>}</li>
 *   <li>{@link RefUML.impl.SlotImpl#getOwningInstance <em>Owning Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotImpl extends ElementImpl implements Slot {
	...
	protected EClass eStaticClass() {
		return RefUMLPackage.Literals.SLOT;
	}
		...
		if (definingFeature != null && definingFeature.eIsProxy()) {
			...
			if (definingFeature != oldDefiningFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefUMLPackage.SLOT__DEFINING_FEATURE, oldDefiningFeature, definingFeature));
			}
		}
	...
	public void setDefiningFeature(StructuralFeature newDefiningFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefUMLPackage.SLOT__DEFINING_FEATURE, oldDefiningFeature, definingFeature));
	}
	...
	public EList<ValueSpecification> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, RefUMLPackage.SLOT__VALUE);
		}
		return value;
	}
	...
	public InstanceSpecification getOwningInstance() {
		if (eContainerFeatureID() != RefUMLPackage.SLOT__OWNING_INSTANCE) return null;
	...
	public NotificationChain basicSetOwningInstance(InstanceSpecification newOwningInstance, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningInstance, RefUMLPackage.SLOT__OWNING_INSTANCE, msgs);
		return msgs;
	}
	...
	public void setOwningInstance(InstanceSpecification newOwningInstance) {
		if (newOwningInstance != eInternalContainer() || (eContainerFeatureID() != RefUMLPackage.SLOT__OWNING_INSTANCE && newOwningInstance != null)) {
			...
			if (newOwningInstance != null)
				msgs = ((InternalEObject)newOwningInstance).eInverseAdd(this, RefUMLPackage.INSTANCE_SPECIFICATION__SLOT, InstanceSpecification.class, msgs);
			msgs = basicSetOwningInstance(newOwningInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefUMLPackage.SLOT__OWNING_INSTANCE, newOwningInstance, newOwningInstance));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RefUMLPackage.SLOT__OWNING_INSTANCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RefUMLPackage.SLOT__VALUE:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RefUMLPackage.SLOT__OWNING_INSTANCE:
				return eInternalContainer().eInverseRemove(this, RefUMLPackage.INSTANCE_SPECIFICATION__SLOT, InstanceSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefUMLPackage.SLOT__DEFINING_FEATURE:

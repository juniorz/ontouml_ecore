 ...
 * <ul>
 *   <li>{@link RefUML.impl.DataTypeImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeImpl extends ClassifierImpl implements DataType {
	...
	protected EClass eStaticClass() {
		return RefUMLPackage.Literals.DATA_TYPE;
	}
	...
	public EList<Property> getOwnedAttribute() {
		if (ownedAttribute == null) {
			ownedAttribute = new EObjectContainmentWithInverseEList<Property>(Property.class, this, RefUMLPackage.DATA_TYPE__OWNED_ATTRIBUTE, RefUMLPackage.PROPERTY__DATATYPE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RefUMLPackage.DATA_TYPE__OWNED_ATTRIBUTE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RefUMLPackage.DATA_TYPE___CREATE_OWNED_OPERATION__STRING_ELIST_ELIST_TYPE:
				createOwnedOperation((String)arguments.get(0), (EList<String>)arguments.get(1), (EList<Type>)arguments.get(2), (Type)arguments.get(3));
				return null;
			case RefUMLPackage.DATA_TYPE___CREATE_OWNED_ATTRIBUTE__STRING_TYPE_INT_INT:
